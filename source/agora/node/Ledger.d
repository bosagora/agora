...
public class Ledger
{
    ...
    ***************************************************************************/
        ...
        @safe nothrow
    {
        ...
        {
            log.info("As this utxo key is ours we will assume preimage is revealed");
            return true;
        }
...
unittest
{
    ...
    // Check that we are not testing skipping with node of test ledger as this will
    // cause us problems as we assume the preimages are revealed for current ledger node
