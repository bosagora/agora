...
public immutable Block GenesisBlock = {
    header: {
        ...
        Enrollment(
            ...
            Signature.fromString(`0x6d7a10ce4912b89806800cd66c6b58e66ccb78625afa865119c6d598aa061d1801e57b1777b7916c7f740826bfb2bc5acb01194126e152119b4b2ae21cc950b4`)),
        ...
        Enrollment(
            ...
            Signature.fromString(`0xa669a117712a49b470c2bfe885015a185c60fc158b8086a74f585804bf8962de0e1c495ac296c96ad1e1b6d9ec1f7fe786a32ce755e99789d180c31c93734133`)),
        ...
        Enrollment(
            ...
            Signature.fromString(`0x221c3179366b4f12cb2ac1a323c312a2c56d96854b9b1aa0a50eb348766b50f50c935a4812a92091ab71974aef902b25f8587e29c9885c5dd1273069059a4f8c`)),
        ...
        Enrollment(
            ...
            Signature.fromString(`0x8ff3e4f89919ce3f010223ffa03ea908c4963cddae7165fa9eaa53d071780d1a07e7b24100c9f24630387e27bb0c2a5c72bccb0da53b3a2b246d3d52ee11bead`)),
        ...
        Enrollment(
            ...
            Signature.fromString(`0x7702482cdbed0ef9751cad41ca46b172edbd4c0db7fe8536ecb82e87aead31fa0ff0a363b51191502a17359d7d129dffd2b529d05eec602bec2ac662a074ef12`)),
        ...
        Enrollment(
            ...
            Signature.fromString(`0x0c7110ea3fcc9fd683ad4b0edcd8956a8716830dee4c8755e773d10f611b32aa088cebaffe5370b905f315a5270c7ee025713eba251a738ee014c13cb2fa4028`)),
        ],
    },
    ...
    txs: [
        ...
        Transaction(
            [
                Output(2_000_000.coins, WK.Keys.NODE8.address, OutputType.Freeze),
                Output(2_000_000.coins, WK.Keys.NODE9.address, OutputType.Freeze),
                Output(2_000_000.coins, WK.Keys.NODE10.address, OutputType.Freeze),
                Output(2_000_000.coins, WK.Keys.NODE11.address, OutputType.Freeze),
                Output(2_000_000.coins, WK.Keys.NODE12.address, OutputType.Freeze),
                Output(2_000_000.coins, WK.Keys.NODE13.address, OutputType.Freeze),
            ]),
        Transaction(
            [
                Output(59_500_000.coins, GenesisOutputAddress),
                Output(59_500_000.coins, GenesisOutputAddress),
                Output(59_500_000.coins, GenesisOutputAddress),
                Output(59_500_000.coins, GenesisOutputAddress),
                Output(59_500_000.coins, GenesisOutputAddress),
