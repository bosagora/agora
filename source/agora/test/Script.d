...
unittest
{
    ...
    auto secret_a = secretKeyToCurveScalar(WK.Keys[42].secret);
    auto kp_a = Pair(secret_a, secret_a.toPoint());
    auto secret_b = secretKeyToCurveScalar(WK.Keys[69].secret);
    auto kp_b = Pair(secret_b, secret_b.toPoint());
