...
class InputWrapper extends Component {
  constructor(props) {
    ...
    this.handleChangeDebounce = debounce(300, !!this.props.onChange ? this.props.onChange.bind(this) : () => { })
  }
  ...
  handleChange(e) {
    ...
    this.handleChangeDebounce(name, e.target.value, true)
  }
  ...
  handleBlur(e) {
    ...
    if (e.target.value.length === 0 && !get(valueStore, [name, "isTouched"], false))
      this.handleChangeDebounce(name, "", true)
  }
    ...
    return (
      <div className={styles.inputWrapper}>
        <CssTextField
          ...
          fullWidth
          defaultValue={get(valueStore, [name, "value"], get(this.props, ["defaultValue"], ""))}
