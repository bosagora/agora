...
import styles from "./sliderPopoverWrapper.module.scss"
...
const SliderPopoverWrapper = props => {
  ...
  return (
    <div className={styles.sliderPopoverWrapper}>
      {props.children}
...
export default React.memo(SliderPopoverWrapper)